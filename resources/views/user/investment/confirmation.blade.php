            ...
            <div class="p-6">
                @if ($investment->isPaid == 1)
                    <div class="p-4 rounded-lg text-white bg-green">
                        Confirmation for invoive {{ $investment->code }} has been sent before, please wait we will process
                        your confirmation as soon as possible.
                    </div>
                @else
