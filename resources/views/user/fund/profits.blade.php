...
@section('content')
    @include('components.page-indicator', [
        'page' => 'Keuntungan Investasi',
        'path' => ['Home', 'Keuntungan'],
    ])
                    ...
                    <table class="w-full table-border">
                        <thead>
                            <tr class="table-border">
                                ...
                                <td class="table-border w-[25%]">Kode Deposit</td>
                                <td class="table-border w-[25%]">Tipe</td>
                            ...
                            @if (count($profitInvests) != 0)
                                @foreach ($profitInvests as $profit)
                                    <tr class="table-border">
                                        ...
                                        <td class="table-border">Paket {{ $profit->package->name }}</td>
